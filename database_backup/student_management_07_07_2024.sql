...
(22, '2024_07_07_064733_create_students_table', 1),
(23, '2024_07_07_065624_create_addresses_table', 1),
(24, '2024_07_07_075359_create_sessions_table', 2),
(25, '2024_07_07_093532_create_subjects_table', 2),
(26, '2024_07_07_120614_create_subject_marks_table', 3);
...
('7DwEoI39s68cFmiVQxdfKvtNvOY8HvJAdzz60qhO', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiN0dhYzZ2SXZuOUlZSHljc3I0bERvRU05Z1drWXhNdDZITjBLakFCNiI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzA6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9zdHVkZW50cyI7fX0=', 1720364297);
...
ALTER TABLE `subject_marks`
  ...
  ADD CONSTRAINT `subject_marks_subject_id_foreign` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`id`) ON DELETE CASCADE;
COMMIT;
